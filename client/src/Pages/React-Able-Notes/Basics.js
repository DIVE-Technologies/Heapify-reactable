      ...
      <Container className="pageSection">
        <ol>
          <li className="listItem">
            ...
            <Content>
              The complete installation process and the extensions to be used
          ...
          <li>
            ...
            <Content>
              ...
              Facebook (launched in 2013) and a community of individual
          ...
          <li className="listItem">
            ...
            <p>
              ...
              interchangeable and each one has pros and cons depending on what
              we are trying to achieve. So here, we’ll get to learn about the
            ...
            <ul style={{ listStyleType: "disc" }}>
              <li className="listItem">
                ...
                <Content>
                  ...
                  with small things, which we use to build bigger things, which
                  we use to build apps. Each component has its own logic and
                  controls its own rendering, and can be reused wherever we need
                  them. Code reuse helps make our apps easier to develop and
                  easier to maintain. They also help us implement a consistent
                  look and feel across the whole project.
                </Content>
              </li>
              <li className="listItem">
                ...
                <Content>
                  ...
                  interaction and data updates, we have to carefully consider
                  how our app structure is going to impact performance. Even
                  with fast client platforms and JavaScript engines, extensive
                  DOM manipulation can be a performance bottle-neck and even
                  result in an annoying user experience. Worse, because the DOM
                  is tree-structured, simple changes at the top level can cause
                  huge ripples to the user interface.
                </Content>
                <Content>
                  ...
                  changes that need to be made to the real DOM. It then
                  determines the most effective way to make these changes and
              ...
              <li className="listItem">
                ...
                <Content>
                  JSX is really just a mix of HTML and JavaScript. It lets us
                  add bits of HTML to our JavaScript. This lets us come up with
                  a much simpler and cleaner code. JSX produces React “elements”
                  and has a number of side benefits, including helping prevent
                  injection attacks. To be fair, there are raging debates on
                  whether JSX is a good thing because it makes coding easier, or
                  a bad thing because it may or may not violate the separation
                  of concerns.
                </Content>
              </li>
              <li className="listItem">
                ...
                <Content>
                  ...
                  process. Using plain JavaScript and React we are able to build
                  a rich UI for native apps, supported by both iOS and Android
                  platforms.
                </Content>
                <Content>
                  ...
                  comes to the actual use of React Native, we can list such
                  mobile apps as Skype, Tesla, Airbnb, and Walmart. And don't
                  forget about Instagram and Facebook – the actual innovators
                  and early adopters.
                </Content>
              </li>
              <li className="listItem">
          ...
          <li>
            ...
            <Table striped bordered hover className="text-left">
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    In ReactJs, Virtual DOM is responsible for rendering the
                    code on the browser.
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    ReactJs is platform-independent i.e. it can be executed on
                    all platforms.
                  </td>
                  <td>
          ...
          <li>
            ...
            <Content>
              This command will install create-react-app in your system
              globally. Once this is done, we are ready to create our first
              react project. In order to do so, follow the below commands -
            </Content>
            <CodeSnippet>npx create-react-app {"{project_name}"}</CodeSnippet>
            <Content>
              The above command will generate a template react project for you
              to begin with. Simply replace the {"{project_name}"} with the name
              of your own project. The contents of the project that you will get
            ...
            <Content>
              By running the above command, your react project will start
              running on localhost:3000 and will open automatically in your
              default browser. Now you are all set. You have installed react and
              have also initialized your very first project.
            </Content>
          </li>
        </ol>
      </Container>
